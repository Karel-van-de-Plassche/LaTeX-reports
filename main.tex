...
\usepackage{karel_packages/extramath}
\usepackage{karel_packages/karel}
\usepackage{karel_packages/document_specific}
...
\hypersetup{pdfsubject=Realtime capable turbulent transport modelling using neural networks}
\hypersetup{pdfauthor=Karel van de Plassche}
\hypersetup{pdfkeywords=turbulent transport tokamak fusion neural network machine learning}
...
%      \emph{Supervisors:} \\
%      {Dr. Roger \textsc{Jaspers}}\\ % Supervisor name - remove the \href bracket to remove the link  
%      Fabien \textsc{Jaulmes} MSc
%  	\end{flushright}
%  \end{minipage}\\[5cm]
%%
%  {\large \today}\\[6cm] % Date
